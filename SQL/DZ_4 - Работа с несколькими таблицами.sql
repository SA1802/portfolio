...
WHERE shops.id NOT IN (
	SELECT DISTINCT shops_id
	FROM cats
	WHERE name  IN ('Murzik', 'Zuza'));
    
-- 4.Вывести название и цену для всех анализов, которые продавались 5 февраля 2020 и всю следующую неделю.

-- создание таблиц задания 4
...
WHERE ord_datetime BETWEEN '2020-02-05 00:00:00' AND DATE_ADD('2020-02-05 00:00:00', INTERVAL 1 WEEK);